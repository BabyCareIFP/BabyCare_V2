                ...
                else if (caja2.getText().toString()=="")
                {
                    ...
                    try {
                        ...
                        if (db.contraseniaCorrecta(correoIntroducido, contraseniaIntroducida))
                        {
                            ...
                            /*pasarPantalla = new Intent(LogInActivity.this, FeedActivity.class); o InicioActivity, BuscadorActivity, CuidadoresActivity...
                            finish();
